...
function handleRequest_(e) {
  try {
    ...
    switch (action) {
      ...
      case 'superAdminListQuotes':      result = superAdminListQuotes_(data.token); break;
      case 'superAdminListSales':       result = superAdminListSales_(data.token); break;
      case 'superAdminListProducts':    result = superAdminListProducts_(data.token); break;
      case 'superAdminListClients':     result = superAdminListClients_(data.token); break;
      case 'superAdminListTrash':       result = superAdminListTrash_(data.token); break;
      case 'superAdminDeleteQuote':     result = superAdminDeleteQuote_(data.token, data); break;
      case 'superAdminCancelSale':      result = superAdminCancelSale_(data.token, data); break;
